...
cd $DIR
zip -r Vertex-theme Chrome Gnome-3.10_Ubuntu-14.04 Gnome-3.12_Ubuntu-14.10 Gnome-3.14 Vertex_alt_metacity Vertex-Gnome-Shell Vertex-Cinnamon LICENSE README
