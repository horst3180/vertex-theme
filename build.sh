...
mkdir -p $DIR/Vertex-theme/Gnome_3-12
cp -r $DIR/Vertex $DIR/Vertex-theme/Gnome_3-12/
cp -r $DIR/Vertex-Light $DIR/Vertex-theme/Gnome_3-12/
...
mkdir -p $DIR/Vertex-theme/Gnome_3-10
mv $DIR/Vertex $DIR/Vertex-theme/Gnome_3-10/
mv $DIR/Vertex-Light $DIR/Vertex-theme/Gnome_3-10/
